    ...
    <form action="{{route('categories.store')}}" method="post" enctype="multipart/form-data">
        ...
        <div class="row">
            <div class="col">
                ...
                <div class="input-group mb-3">
                    <input type="text" class="form-control @error('name_ar') is-invalid @enderror" name="name_ar"required>
                </div>
                @error('name_ar')
            ...
            <div class="col">
                ...
                <div class="input-group mb-3 col">
                    <input type="text"  class="form-control @error('name_en') is-invalid @enderror" name="name_en"required>
        ...
        <div class="row">
            <div class="col">
                ...
                <div class="input-group mb-3">
                    <input type="text" class="form-control  @error('slug') is-invalid @enderror" name="slug" required>
                </div>
                @error('slug')
                <div class="alert alert-danger">{{ $message }}</div>
                @enderror
            ...
            <div class="col">
                ...
                <div class="input-group mb-3">
                    <textarea name="description_ar" rows="3" cols="3"
                            class="form-control @error('description_ar') is-invalid @enderror"required></textarea>
                </div>
            ...
            <div class="col">
                ...
                <div class="input-group mb-3">
                    <textarea name="description_en" rows="3" cols="3"
                            class="form-control @error('description_en') is-invalid @enderror"required></textarea>
                </div>
