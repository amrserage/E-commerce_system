...
<?php endif; ?>
        ...
        <div class="row">
            ...
            <div class="col">
                <label for="image">{{trans('product_trans.images')}}</label>
                <div class="input-group mb-3 col">
            ...
            <div class="col">
                ...
                <div class="input-group mb-3">
                    <textarea name="short_description_ar" rows="3" cols="3"
                                class="form-control @error('short_description_ar') is-invalid @enderror"></textarea>
                </div>
            ...
            <div class="col">
                ...
                <div class="input-group mb-3">
                    <textarea name="short_description_en" rows="3" cols="3"
                                class="form-control @error('short_description_en') is-invalid @enderror"></textarea>
                </div>
